...
from transformers import Qwen2Config, Qwen2Model, Qwen2ForCausalLM, Qwen2ForSequenceClassification
...
class LlavaQwenClassifier(Qwen2ForSequenceClassification, LlavaMetaForCausalLM):
    config_class = LlavaQwenConfig

    def __init__(self, config):
        super(Qwen2ForSequenceClassification, self).__init__(config)
        self.model = LlavaQwenModel(config)
