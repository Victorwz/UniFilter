...
from transformers import AutoConfig, AutoModelForCausalLM, \
                         Phi3Config, Phi3Model, Phi3ForCausalLM, Phi3ForSequenceClassification
...
class LlavaPhi3Classifier(Phi3ForSequenceClassification, LlavaMetaForCausalLM):
    config_class = LlavaPhi3Config

    def __init__(self, config):
        super(Phi3ForSequenceClassification, self).__init__(config)
        self.model = LlavaPhi3Model(config)
        # self.pretraining_tp = config.pretraining_tp
